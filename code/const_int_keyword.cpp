...
int main() {
    ...
    // note all these blue highlighted stuffs in vs code are reserved keywords, u can't use them for identifiers, or declaring some other variables
